import {
  NDKEvent,
  NDKKind,
  NDKPrivateKeySigner, NDKRelayList,
  NDKSubscription,
  NDKUser
} from "@nostr-dev-kit/ndk";

import type { NDKFilter, NDKTag, NDKUserProfile } from "@nostr-dev-kit/ndk";
...
export class NostrUserHandler {
   ...
   */
  public async reactToEvent(eventToReactTo : NDKEvent, reaction: Reactions) : Promise<void> {
